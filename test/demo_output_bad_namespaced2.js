(function (root, factory) {
    ...
    } else if (typeof root["app"]["isBoolean"] === 'undefined' || root["app"]["isBoolean"] !== Object(root["app"]["isBoolean"])) {
        throw new Error('templatizer: window["app"]["isBoolean"] does not exist or is not an object');
    } else {
        root["app"]["isBoolean"].templatizer = factory();
    }
}(this, function () {
