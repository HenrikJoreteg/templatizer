(function (root, factory) {
    ...
    } else if (typeof root["multipleDirs"] === 'undefined' || root["multipleDirs"] !== Object(root["multipleDirs"])) {
        throw new Error('templatizer: window["multipleDirs"] does not exist or is not an object');
    } else {
        root["multipleDirs"].templatizer = factory();
    }
}(this, function () {
