(function (root, factory) {
    ...
    } else if (typeof root["unaltered"] === 'undefined' || root["unaltered"] !== Object(root["unaltered"])) {
        throw new Error('templatizer: window["unaltered"] does not exist or is not an object');
    } else {
        root["unaltered"].templatizer = factory();
    }
}(this, function () {
