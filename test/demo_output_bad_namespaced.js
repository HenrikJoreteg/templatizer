(function (root, factory) {
    ...
    } else if (typeof root["app"]["nonExistant"] === 'undefined' || root["app"]["nonExistant"] !== Object(root["app"]["nonExistant"])) {
        throw new Error('templatizer: window["app"]["nonExistant"] does not exist or is not an object');
    } else {
        root["app"]["nonExistant"].templatizer = factory();
    }
}(this, function () {
