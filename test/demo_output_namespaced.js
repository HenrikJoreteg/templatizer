(function (root, factory) {
    ...
    } else if (typeof root["app"]["nested"] === 'undefined' || root["app"]["nested"] !== Object(root["app"]["nested"])) {
        throw new Error('templatizer: window["app"]["nested"] does not exist or is not an object');
    } else {
        root["app"]["nested"].templatizer = factory();
    }
}(this, function () {
